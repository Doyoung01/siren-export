...
public class makeHint : MonoBehaviour
{
    ...
    string[] rhintString = {
        "부엌에 청결하지 못한 곳이 있는 것 같아.", "시원해서 좋긴 하지만…",
        "가스레인지 쪽을 잘 살펴보자!", "킁킁, 어디서 가스 냄새 나는 거 같지 않아?",
        "너무 오래 가열시키면 안돼", "소방 용품을 한 번 살펴보자",
    };
    string[] hhintString = {
        "뭐지 이 타는 냄새는..?", "어디서 치지직 소리가 나는데..",
        "어디서 치지직 소리가 나는데..", "내가 드라이기 코드를 뽑았었나?",
        "뭐지 이 빵 타는 냄새는..?", "내가 가스라인지를 껐었나..?",
    };
